...
ErrorOverlay.setEditorHandler(function editorHandler(errorLocation) {
  ...
  fetch("".concat(launchEditorEndpoint, "?fileName=") + window.encodeURIComponent(errorLocation.fileName) + '&lineNumber=' + window.encodeURIComponent(errorLocation.lineNumber || 1));
...
if (process.env.SOCKET_SERVER !== 'none') {
  ...
  socket(process.env.SOCKET_SERVER ? "".concat(stripLastSlash(process.env.SOCKET_SERVER), "/sockjs-node") : url.format({
